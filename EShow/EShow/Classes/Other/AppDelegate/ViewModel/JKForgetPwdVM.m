...
@implementation JKForgetPwdVM
#pragma mark -- 提交
- (void)submitRequestWithSuccessBlock:(ReturnSuccessBlock)successBlock
    ...
    [params setObject:self.npwdStr forKey:kUserConfirmPassword];
    
    NSString *urlStr = [NSString stringWithFormat:@"%@",URL_Forget_Password_Reset];
...
- (void)verificationRequestWithSuccessBlock:(ReturnSuccessBlock)successBlock
    ...
    [params setObject:kPassword forKey:kCaptchaType];
